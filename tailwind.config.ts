...
const config: Config = {
  ...
  theme: {
    extend: {
      /* Fonts from your RootLayout (Inter + Libre Bodoni) */
      fontFamily: {
        display: ["Libre Bodoni", ...fontFamily.serif],
        sans: [...fontFamily.sans],
      },
      ...
      /* -----------------------------
         Colors
         All the main tokens now pull from CSS variables
         you set in globals.css (GREEN palette).
         ----------------------------- */
      colors: {
        // shadcn tokens
        background: "hsl(var(--background))",
        ...
        /* BRAND (now green) — map to CSS variables from globals.css */
        ...
        /* Back-compat aliases if you used brand.primary etc. */
        brand: {
          ...
          // Keep dark tokens as-is for dark theme (optional)
          "dark-bg": "#0B0B0F",
          surface: "#121217",
          text: "#EDECF3",
        },
